...
#define TAGKEYS(CHAIN,KEY,TAG) \
	...
	{ ControlMask|ShiftMask,        CHAIN,    KEY,      tag,            {.ui = 1 << TAG} }, \
...
/* commands */
static const char dmenufont[] = "MesloLGS NS:size=10";
...
static const Key keys[] = {
		...
		{ MODKEY|ControlMask,                  -1,         XK_f,      setlayout,      {.v = &layouts[1]} },
		{ MODKEY|ControlMask,                  -1,         XK_m,      setlayout,      {.v = &layouts[2]} },
  ...
  { MODKEY|ShiftMask,             -1,         XK_0,      tag,            {.ui = ~0 } },
		...
		{ MODKEY,                       		-1,	    XK_m, spawn, 			   {.v = mute_vol } },
